...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('telephone', models.CharField(blank=True, help_text='电话（CharField）', max_length=20, verbose_name='电话')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('group', models.ManyToManyField(blank=True, help_text='可见分组', related_name='UserExtension_group', to='auth.Group', verbose_name='可见分组')),
                ('portrait', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='users.Portrait', verbose_name='用户头像')),
        ...
        migrations.AddField(
            model_name='portrait',
            name='created_by',
            field=models.ForeignKey(blank=True, help_text='创建人ID（ForeignKey）', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='portrait_cb', to='users.UserExtension', verbose_name='创建人ID'),
        ),
        migrations.AddField(
            model_name='portrait',
            name='group',
            field=models.ManyToManyField(blank=True, help_text='可见分组', related_name='Portrait_group', to='auth.Group', verbose_name='可见分组'),
        ),
        migrations.AddField(
            model_name='portrait',
            name='last_edited_by',
            field=models.ForeignKey(blank=True, help_text='最后编辑人ID（ForeignKey）', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='portrait_eb', to='users.UserExtension', verbose_name='最后编辑人ID'),
        ),
    ]
