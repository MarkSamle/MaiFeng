                        ...
                        children: <Widget>[
                          ...
                          Container(
                            ...
                            child: TextFormField(
                              ...
                              decoration: InputDecoration(
                                icon: Icon(Icons.person, color: Color.fromARGB(255, 0, 162, 255)),
                                hintText: '请输入账号',
                          ...
                          Container(
                            ...
                            child: TextFormField(
                              ...
                              maxLength: 16,
                              decoration: InputDecoration(
                                icon: Icon(Icons.face, color: Color.fromARGB(255, 0, 162, 255)),
                                hintText: '请输入姓名或昵称',
                                border: InputBorder.none,
                                counter: SizedBox(),
                              ),
                          ...
                          Container(
                            ...
                            child: TextFormField(
                              ...
                              maxLength: 50,
                              decoration: InputDecoration(
                                icon: Icon(Icons.assignment, color: Color.fromARGB(255, 0, 162, 255)),
                                hintText: '请输入个性签名',
                                border: InputBorder.none,
                                counter: SizedBox(),
                              ),
